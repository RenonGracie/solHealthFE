...
export const PreviousTherapistCard = ({ photoSrc, name, onClick }: IProps) => {
  return (
    <button
      onClick={onClick}
      className="hover:cursor-pointer hover:opacity-80 appearance-none bg-transparent p-0 m-0 flex flex-col flex-shrink-0 items-center justify-center py-4 lg:py-5 rounded-[8px] border border-[var(--brand-brown)] w-[186px] lg:w-[346px]"
    >
